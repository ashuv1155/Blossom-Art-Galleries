...
target_bags = ["BAG 226", "BAG 228"]
new_category = "Artificial green wall panel"
new_slug = "artificial-green-wall-panel"
...
print(f"SUCCESS! Moved BAGs 226, 228 to {new_category}.")

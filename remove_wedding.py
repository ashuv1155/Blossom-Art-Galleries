...
target_bags = ["BAG 1", "BAG 49", "BAG 50", "BAG 51", "BAG 52", "BAG 53", "BAG 54", "BAG 61", "BAG 63", "BAG 83"]
new_category = "Event Decor"
new_slug = "event-decor"

# Define the NEW 12 categories
categories_ordered = [
    "Artificial Flowers",
    "Dried Decorations",
    "Event Decor",
...
print(f"Updated CSVs! {new_category} now has {new_counts[new_category]} items.")
...
for file_path in html_files:
    ...
    # Update animated category counters (data-target="13" -> "12")
    if file_path.endswith('index.html') or file_path.endswith('about.html'):
        html = re.sub(r'data-target="13"', 'data-target="12"', html)
        # Fix static fallback if present
        html = re.sub(r'>13<', '>12<', html)
    
    with open(file_path, 'w', encoding='utf-8') as f:
        f.write(html)
        
print("Updated all HTML files to remove Wedding Decor from the dropdown menu and updated counters to 12.")
...
print("SUCCESS! Completed move and removal.")

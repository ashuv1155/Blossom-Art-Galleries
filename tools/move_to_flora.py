...
target_bags = ["BAG 290", "BAG 291", "BAG 295", "BAG 300", "BAG 301"]
new_category = "Artificial Flora"
new_slug = "artificial-flora"
...
print(f"Updated CSVs! Artificial Flora now has {new_counts['Artificial Flora']} items.")
...
print("SUCCESS! Moved 5 specific bags to Artificial Flora.")

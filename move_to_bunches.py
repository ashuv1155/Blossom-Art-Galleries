...
target_bags = ["BAG 159", "BAG 164", "BAG 167", "BAG 188"]
new_category = "Artificial flower bunches"
new_slug = "artificial-flower-bunches"
...
print(f"Updated CSVs! Artificial flower bunches now has {new_counts['Artificial flower bunches']} items.")
...
print("SUCCESS! Moved 4 specific bags to Artificial flower bunches.")
